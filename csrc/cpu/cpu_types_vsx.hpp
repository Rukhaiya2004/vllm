...
// NOTE: FP16 (Half) is supported on Power via custom bit-manipulation
// conversion. PyTorch itself lacks native Power FP16 support.
...
FORCE_INLINE __vector unsigned int fp32_to_fp16_bits(__vector float f_in) {
  ...
  const __vector unsigned int mask_sign_32 = {0x80000000, 0x80000000, 0x80000000, 0x80000000};
  const __vector unsigned int mask_exp_32 = {0x7F800000, 0x7F800000, 0x7F800000, 0x7F800000};
  const __vector unsigned int mask_mant_32 = {0x007FFFFF, 0x007FFFFF, 0x007FFFFF, 0x007FFFFF};
  ...
  __vector __bool int sticky_nonzero = vec_cmpgt(sticky, (__vector unsigned int){0, 0, 0, 0});
  __vector __bool int lsb_set = vec_cmpeq(lsb, one_v);
  __vector __bool int round_up = vec_and(vec_cmpeq(round_bit, one_v), vec_or(sticky_nonzero, lsb_set));
  ...
  __vector __bool int would_overflow_to_inf = vec_and(mant_overflows, vec_cmpeq(e_final, max_normal_exp));
...
struct FP32Vec8 : public Vec<FP32Vec8> {
  ...
  explicit FP32Vec8(const FP16Vec8& v) {
    ...
    __vector unsigned int raw_hi = (__vector unsigned int)vec_unpackh((__vector signed short)raw_u);
    __vector unsigned int raw_lo = (__vector unsigned int)vec_unpackl((__vector signed short)raw_u);
...
inline void storeFP32<c10::Half>(float v, c10::Half* ptr) {
  ...
  unsigned short result = (unsigned short)((__vector unsigned short)fp16_bits)[0];
...
inline FP16Vec8::FP16Vec8(const FP32Vec8& v) {
  ...
  reg = (__vector signed short)vec_perm((__vector unsigned char)fp16_hi,
                                        (__vector unsigned char)fp16_lo,
                                        omask);
}
...
inline FP16Vec16::FP16Vec16(const FP32Vec16& v) {
  ...
  reg.val[0] = (__vector signed short)vec_perm((__vector unsigned char)fp16_0,
                                                (__vector unsigned char)fp16_1,
                                                omask);
  reg.val[1] = (__vector signed short)vec_perm((__vector unsigned char)fp16_2,
                                                (__vector unsigned char)fp16_3,
                                                omask);
}
...
inline FP32Vec16::FP32Vec16(const FP16Vec16& v) {
  ...
  __vector unsigned int raw_hi0 = (__vector unsigned int)vec_unpackh((__vector signed short)raw_u0);
  __vector unsigned int raw_lo0 = (__vector unsigned int)vec_unpackl((__vector signed short)raw_u0);
  __vector unsigned int raw_hi1 = (__vector unsigned int)vec_unpackh((__vector signed short)raw_u1);
  __vector unsigned int raw_lo1 = (__vector unsigned int)vec_unpackl((__vector signed short)raw_u1);
